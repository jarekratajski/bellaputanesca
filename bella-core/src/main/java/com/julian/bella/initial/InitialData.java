...
public class InitialData implements CommandLineRunner {
	...
	public InitialData(ClientRepo clientRepo, AddressRepo addressRepo, OrderRepo orderRepo, OrderFinancesRepo orderFinancesRepo, ParcelRepo parcelRepo,
			LocationRepo locationRepo, VehicleRepo vehicleRepo, DriverRepo driverRepo, ShipperRepo shipperRepo, CallCenterConsultantRepo cccRepo, RouteRepo routeRepo, 
			UserRepo userRepo) {
	...
	public void initData() {
		...
		CallCenterConsultant employee2 = new CallCenterConsultant("01241726014", "Julian", "Kowalski", false);
		cccRepo.save(employee2);
